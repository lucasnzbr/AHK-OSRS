...
Gui, Show, x5 y5 w205 h182, Fletching
gui, +alwaysontop
return
...
If (script == "Bows From Logs") {
	Quantidadedeloopsaseremfeitosscriptbowlogs:=Ceil(quantidade/27)

	Loop %Quantidadedeloopsaseremfeitosscriptbowlogs% {
