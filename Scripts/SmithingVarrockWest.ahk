...
Gui, Add, Text, x12 y49 w80 h20 cred vfcinco , Anvil x1y1(F5)
Gui, Add, Text, x12 y69 w80 h20 cred vfseis, Anvil x2y2(F6)
Gui, Add, Text, x12 y99 w90 h20 cred vfsete, Bank x1y1(F7)
Gui, Add, Text, x12 y119 w90 h20 cred vfoito, Bank x2y2(F8)
...
If (script == "Running 1bar Itens") {
	Quantidadedeloopsaseremfeitosscriptrunning1bar:=Ceil(quantidade/26)

	Loop %Quantidadedeloopsaseremfeitosscriptrunning1bar% {

	mousegetpos,currentposx, currentposy
	random, anvilx, fcincox,fseisx
	random, anvily, fcincoy,fseisy
	RandomBezier(currentposx, currentposy, anvilx, anvily, "T600 OT15 OB15 OL15 OR15" ) ;mouse to anvil
	sleeptime(100,300)
	Click
	Sleeptime(5000,7000)
...
Send {space}
	...
	random,sleeptimer,80000,84000
	sleeptimer2:=(sleeptimer/26)
	loop 26{
		sleep sleeptimer2
		itensfeitos++
	...
	mousegetpos,currentposx, currentposy
	random, bankx, fsetex,foitox
	random, banky, fsetey,foitoy
	...
	fnovex:=fnovex+var1
	fnovey:=fnovey+var2
	RandomBezier(currentposx, currentposy, fnovex, fnovey, "T600 OT15 OB15 OL15 OR15" ) ;mouse to bank
	fnovex:=fnovex-var1
	fnovey:=fnovey-var2
	sleeptime(100,300)
	Click
