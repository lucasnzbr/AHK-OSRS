...
Gui, Add, Edit, x102 y19 w70 h20 vqtde, 150
Gui, Add, Text, x12 y19 w80 h20 , Qtde minutos
...
quantidade:=Floor(qtde/3)

random,randomoff1,10000,13000
random,randomoff2, 15000,17000
random,randomoff3 ,20000,23654
random,randomoff4 ,25000,30000

Loop {
random, spot1x, fsetex, foitox
random, spot1y, fsetey, foitoy

	GuiControl, , oresminerados ,  %oresminerados% Ores.
	GuiControl, , xpmade ,  %xpmade% Xp.

	mousegetpos, currentposx, currentposy
	RandomBezier(currentposx, currentposy, spot1x, spot1y, "T600 OT15 OB15 OL15 OR15" )
	sleeptime(100,150)
	Click
	random, random1,randomoff1,randomoff2
	random, random2,randomoff3,randomoff4
	sleeptime(random1,random2)



pixelsearch,fodasex,fodasey,1601,976,1601,976,0x29353E,1,fast
If (Errorlevel == 1){
	gosub,dropinv
}
